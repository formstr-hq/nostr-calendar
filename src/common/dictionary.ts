...
const dictionary: NestedObject = {
  "en-US": {
    ...
    event: {
      ...
      busy: "Busy",
      free: "Free",
      attachmentsToggle: "Attachments — Formstr form",
      save: "Save",
      invitees: "Invitees",
      repeatLabel: "Repeat",
      dateLabel: "Date",
    ...
    form: {
      ...
      addAttachment: "Add",
      myForms: "My Forms",
      loadingMyForms: "Loading your forms…",
      noMyFormsBefore: "No forms found. You can create one at",
      noMyFormsAfter: "and then attach that form",
      retryMyForms: "Retry",
    ...
    login: {
      ...
      existingKeyDescription: "Sign in with an ncryptsec",
      createAccount: "Create Account",
      createAccountDescription: "Generate a new key, encrypted at rest",
      nip07Providers: "Alby, nos2x, Flamingo",
      uploadKey: "Upload key file",
      uploadKeyHint: "Choose the encrypted key file you saved earlier.",
      invalidNcryptsec: "Invalid ncryptsec or wrong passphrase.",
      ncryptsecPlaceholder: "ncryptsec1…",
      passphrase: "Passphrase",
      confirmPassphrase: "Confirm Passphrase",
      showPassphrase: "Show passphrase",
      hidePassphrase: "Hide passphrase",
      keyFileInvalid: "Please choose a .txt key file.",
      keyFileEmpty: "The key file is empty.",
      keyFileReadFailed: "Could not read key file.",
      passphrasesDoNotMatch: "Passphrases don't match.",
      createAccountFailed: "Failed to create account.",
      backupKey: "Back up your key",
      backupKeyWarning:
        "Save this encrypted key. Without it and your passphrase you cannot sign in again.",
      copied: "Copied!",
      copyNcryptsec: "Copy ncryptsec",
      downloadKey: "Download key file",
      savedKey: "I've saved it",
      name: "Name",
      imageUrl: "Image URL",
      about: "About",
      encryptsKeyHint: "Encrypts your key. Never stored.",
      cancel: "Cancel",
      create: "Create",
      relayListLabel: "Relays (one per line)",
  ...
  "de-DE": {
    ...
    form: {
      ...
      loadingMyForms: "Ihre Formulare werden geladen…",
      noMyFormsBefore: "Keine Formulare gefunden. Sie können eines unter",
      noMyFormsAfter: "erstellen und dann hier anhängen.",
      retryMyForms: "Erneut versuchen",
    ...
    login: {
      ...
      calendarAlt: "Kalender",
      existingKey: "Vorhandener Schlüssel",
      existingKeyDescription: "Mit einem ncryptsec anmelden",
      createAccount: "Konto erstellen",
      createAccountDescription:
        "Neuen Schlüssel erstellen, verschlüsselt gespeichert",
      nip07Providers: "Alby, nos2x, Flamingo",
      uploadKey: "key file hochladen",
      uploadKeyHint:
        "Wählen Sie die zuvor gespeicherte verschlüsselte Schlüsseldatei aus.",
      invalidNcryptsec: "Ungültiges ncryptsec oder falsche Passphrase.",
      ncryptsecPlaceholder: "ncryptsec1…",
      passphrase: "Passphrase",
      confirmPassphrase: "Passphrase bestätigen",
      showPassphrase: "Passphrase anzeigen",
      hidePassphrase: "Passphrase verbergen",
      keyFileInvalid: "Bitte wählen Sie eine .txt-Schlüsseldatei.",
      keyFileEmpty: "Die Schlüsseldatei ist leer.",
      keyFileReadFailed: "Schlüsseldatei konnte nicht gelesen werden.",
      passphrasesDoNotMatch: "Die Passphrasen stimmen nicht überein.",
      createAccountFailed: "Konto konnte nicht erstellt werden.",
      backupKey: "Schlüssel sichern",
      backupKeyWarning:
        "Speichern Sie diesen verschlüsselten Schlüssel. Ohne ihn und Ihre Passphrase können Sie sich nicht erneut anmelden.",
      copied: "Kopiert!",
      copyNcryptsec: "ncryptsec kopieren",
      downloadKey: "key file herunterladen",
      savedKey: "Ich habe ihn gespeichert",
      name: "Name",
      imageUrl: "Bild-URL",
      about: "Über mich",
      encryptsKeyHint: "Verschlüsselt Ihren Schlüssel. Wird nie gespeichert.",
      cancel: "Abbrechen",
      create: "Erstellen",
      relayListLabel: "Relays (eine pro Zeile)",
      relayListHint: "Relays für die nostrconnect-QR-Sitzung",
      relayRequired:
        "Für die QR-Anmeldung ist mindestens ein Relay erforderlich.",
    },
    relay: {
    ...
    participant: {
      ...
      alreadyInEvent: "Bereits im Termin",
      ...
      noHistory: "Noch keine Kontakte oder früheren Teilnehmer",
      sharedEvent: "Gemeinsamer Termin",
      inContacts: "In Ihrer Kontaktliste",
    },
    report: {
