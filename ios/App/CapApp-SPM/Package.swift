...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "KhadarvskCapacitorSecureStorage", path: "../../../node_modules/.pnpm/@khadarvsk+capacitor-secure-storage@0.0.3_@capacitor+core@8.0.0/node_modules/@khadarvsk/capacitor-secure-storage"),
