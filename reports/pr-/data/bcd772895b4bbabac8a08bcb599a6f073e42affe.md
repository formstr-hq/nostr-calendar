...
- Name: booking.spec.ts >> booker requests a slot and the host declines it with a reason
- Location: e2e/web/tests/booking.spec.ts:97:1
  ...
  - generic [ref=e3]:
    - generic [ref=e5]:
      - generic [ref=e6]:
        ...
        - heading "Decline Flow msar1ktw" [level=4] [ref=e10]
      - generic [ref=e11]:
        - generic [ref=e12]:
          - generic [ref=e13]:
    ...
    - contentinfo [ref=e40]: Shown in your timezone (UTC+0) · 19:13 for the host.
```
